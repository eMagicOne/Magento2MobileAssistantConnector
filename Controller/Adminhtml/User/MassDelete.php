 ...
 */
class MassDelete extends AbstractUserMassAction
{
    /**
    ...
    protected function massAction(Collection $collection)
    {
        ...
        foreach ($collection->getAllIds() as $userId) {
            ...
            $this->userFactory->create()->load($userId)->delete();

            $this->_objectManager->create('Emagicone\Mobassistantconnector\Model\SessionKey')->deleteByUserId($userId);
        ...
        if ($usersUpdated) {
            $this->messageManager->addSuccess(__('A total of %1 record(s) were deleted.', $usersUpdated));
        }
